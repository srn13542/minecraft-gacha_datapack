...
$execute at @e[type=item_display,tag=fgacha_machine,nbt={UUID:$(link)}] run summon item ~ ~1 ~ {Item:{id:"minecraft:paper",count:1,components:{item_model:"fgacha:gacha_machine",custom_data:{fgacha:{gacha_machine:true}}}}}
